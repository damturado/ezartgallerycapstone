...
<section class="checkout">
   <form action="" method="post">
      ...
      <div class="flex">
         <div class="inputBox">
            <span>Name:</span>
            <input type="text" name="name" required placeholder="Complete Name">
         </div>
         <div class="inputBox">
         ...
         <div class="inputBox">
            <span>Province:</span>
            <input type="text" name="state" required placeholder="Province">
         </div>
         <div class="inputBox">
            <span>Country:</span>
         ...
         <div class="inputBox">
            <span>Zip Code:</span>
            <input type="number" min="0" name="pin_code" required placeholder="Zip Code">
         </div>
      </div>
